...
public abstract class AlunoPersistenciaSituacaoENome {
    
    //Atributos
    private String nomeDoArquivo;
    private String nomeDoArquivo1;
    //Metodos
    public AlunoPersistenciaSituacaoENome(String situacao, String nome){
    ...
    public ArrayList<Aluno> listagemDeAlunosSituacaoENome()throws Exception{
        try{
