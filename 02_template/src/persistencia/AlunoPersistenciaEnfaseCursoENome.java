...
public abstract class AlunoPersistenciaEnfaseCursoENome {
    ...
    //Metodos
    public AlunoPersistenciaEnfaseCursoENome(String enfase, String curso, String nome){
    ...
    public ArrayList<Aluno> listagemDeAlunosEnfaseCursoENome()throws Exception{
        try{
